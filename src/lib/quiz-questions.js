export const quizQuestions = [
  {
    id: "energy",
    question: "How do you like to spend your energy after work or school?",
    emoji: "⚡",
    options: [
  ...
  {
    id: "social",
    question: "What social setup feels best for you?",
    emoji: "🐺",
    options: [
  ...
  {
    id: "compete",
    question: "How competitive do you want your sessions to be?",
    emoji: "🏆",
    options: [
  ...
  {
    id: "schedule",
    question: "What weekly time commitment is realistic for you?",
    emoji: "⏰",
    options: [
  ...
  {
    id: "vibe",
    question: "Which movement style matches your personality?",
    emoji: "🎵",
    options: [
  ...
  {
    id: "experience",
    question: "Where are you right now in your sports journey?",
    emoji: "📈",
    options: [
  ...
  {
    id: "impact",
    question: "How much physical impact feels right for your body?",
    emoji: "🦵",
    options: [
  ...
  {
    id: "budget",
    question: "What's your realistic gear budget to get started?",
    emoji: "💸",
    options: [
  ...
  {
    id: "goal",
    question: "What would make this sport feel like a win for you?",
    emoji: "🎯",
    options: [
